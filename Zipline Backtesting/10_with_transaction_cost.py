...
from zipline.api import order_target_percent, record, symbol, set_long_only, set_max_leverage, set_commission, set_slippage
...
if __name__ == "__main__":
    ...
    results.to_pickle("multi_stock_macd_yfinance_with_cost_results.pickle")
    print(results.tail())